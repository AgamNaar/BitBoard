...
import static Utils.BoardUtils.WHITE;
...
public class PieceImage {
    ...
    private void insertImageToCollection(File f) throws IOException {
        ...
        if (color == WHITE)
            whitePiecesImages[type] = ImageIO.read(f);
        else
            blackPiecesImages[type] = ImageIO.read(f);
    }
